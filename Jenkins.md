...
*	Change the softlink. Go back to cd /usr/bin
*	Ls -al | grep java
...
* *	Global Tool Config
* *	Under ANT 
* *	Ant installations – name = Local_Ant (Some_Name)
...
* *	Under build 
* *	Invoke ant
* *	Ant version – Local_Ant (Which you have given during ANT INSTALLATION)
* * Targets – leave like that. 
* *	Save 
* 	Build job now
## You can see
...
* *	In Build Trigger => check the Github Hook Trigger for GITSCM polling
* *	Save
...
*	We have jar file in S3. We need to download it automatically. Other cannot access our S3 bucket since it is private. So, we will create a ROLE and attach it to EC2 instances
*	IAM ROLE
*	Create Role
* *	EC2 role
* *	S3fullAccess
...
*	Cd jars
*	pwd
*  Run below command You can see .jar file in s3 bucket will be downloaded in your ec2
